...
namespace PixelEngine.Utilities
{
	public static class Json
	{
		public static string Stringify<T>(T item)
		{
			...
			else
			{
				...
				{
					return JsonHelper.Stringify(new JsonArray(en));
				}
				...
				void Convert(object o, StringBuilder text)
				{
					switch (o)
					{
						...
						case Dictionary<string, object> dict:
							Convert(new JsonObject(dict), text);
							return;

						case IEnumerable list:
							Convert(new JsonArray(list), text);
							return;
	...
	public class JsonObject : IJsonType
	{
		...
		public JsonObject() { }
		public JsonObject(IDictionary<string, object> entries)
		{
	...
	public class JsonArray : IJsonType
	{
		...
		public JsonArray() { }
		public JsonArray(params object[] entries) : this(entries.AsEnumerable()) { }
		public JsonArray(IEnumerable<object> entries)
		{
